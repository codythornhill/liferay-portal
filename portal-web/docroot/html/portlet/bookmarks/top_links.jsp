			...
			<div class="form-search">
				<aui:form action="<%= searchURL %>" method="get" name="searchFm">
					...
					<div class="input-append">
						<aui:input autoFocus="<%= windowState.equals(WindowState.MAXIMIZED) %>" class="search-query span9" id="keywords1" name="keywords" placeholder="<liferay-ui:message key="keywords" />" />
